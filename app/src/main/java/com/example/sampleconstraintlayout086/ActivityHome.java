...
public class ActivityHome extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    //Memanggil class ListviewAdapter dan diinisialisasi menjadi variabel adapter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                //Deklarasi variabel nama yang berisi item yang dipilih
